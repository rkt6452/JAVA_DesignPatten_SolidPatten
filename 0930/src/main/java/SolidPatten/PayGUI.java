...
public class PayGUI extends Frame implements ActionListener, DocumentListener {
	...
	private JLabel overTimeHoursLable = new JLabel("Overtime Hours = ", Label.RIGHT);
	...
	public void init() {
		...
		p1.add("West", overTimeHoursLable);
	...
	public void start() {
		calcButton.addActionListener(this);// 버튼이 눌렸는지
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == calcButton) {
			...
			int payAmount = 0;
			payAmount = pc.calculator(x, y);//PayCalculator 의 calculate 호출
